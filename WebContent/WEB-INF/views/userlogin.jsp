	...
	<div id="main-wraper">
		...
		<table style="width: 100%; display: inline-block;">
			<tbody>
				<tr>
					<td>
						<h2>Easy Research - <c:out value="${usertype}"></c:out> Login</h2>
					</td>
				</tr>
				<tr>
					...
					<c:when test="${userstatus!=null}">
						...
						<form name="form1" action="${pageContext.request.contextPath}/douserlogin" method="post"
								...
								<tbody>
									<tr>
										...
										<td class="tableinputtext"><input class="tableinput"
											type="text" name="username" /><input type="hidden" name="typeofuser" value="${usertype}" /></td>
									</tr>
									<tr>
						...
						~OR~</td>
					<td><strong>Create an Account.Its free and always
							will be.</strong><br /> <span class="author_signup"><a
							href="${pageContext.request.contextPath}/usersignup?type=Author">Sign Up </a></span></td>
						</c:if>
